...
export const allProjects: ProjectData[] = [
        ...
        content: [
          {
            type: "list",
            items: [
              "Interactive 3D visualization of the rendering pipeline stages",
              "Custom GLSL shaders demonstrating various rendering techniques",
              "Educational content explaining graphics programming concepts"
            ]
          }
        ]
      },
  ...
  },
  {
    id: "7",
    title: "Phantom Flash",
    shortDescription: "Navigate a haunted mansion using your investigative journal and spectral camera to uncover hidden truths in this atmospheric horror-puzzle adventure.",
    ...
    heroMedia: {
      type: 'image',
      src: "https://raw.githubusercontent.com/deep-river/OnlinePortfolio/refs/heads/main/img/PhantomFlash-StartScreen.jpg",
      alt: "Phantom Flash Screenshot"
    },
    overviewDescription: "Navigate a haunted mansion using your investigative journal and spectral camera to uncover hidden truths in this atmospheric horror-puzzle adventure. Brave eerie encounters and solve environmental riddles while evading vengeful spirits trapped within the mist.",
    projectInfo: {
    ...
    roles: [
      {
        title: "Unity Programmer & System Designer",
        responsibilities: [
          "Designed and implemented core gameplay systems",
          "Created puzzle mechanics and environmental interactions",
          "Developed the spectral camera functionality"
        ]
      }
    ],
    detailedSections: [
            ...
            media: [
              {
                type: "image",
                src: "https://raw.githubusercontent.com/deep-river/OnlinePortfolio/refs/heads/main/img/PhantomFlash-StartScreen.jpg",
                alt: "Phantom Flash Start Screen"
              }
            ]
          }
        ]
